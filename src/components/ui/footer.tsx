                    ...
                    <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
                        <div className="col-span-2 mb-8 lg:mb-0">
                            <div className="flex items-center gap-2 lg:justify-start">
                                <a href="https://github.com/loeclos">
                                    <Image
                                        src={logo.src}
                                        alt={logo.alt}
                                        width={30}
                            ...
                            <p className="mt-4 font-bold text-sm font-mono italic text-red-400/40">{tagline}</p>
                        </div>
                            ...
                            <div key={sectionIdx}>
                                ...
                                <ul className="space-y-4 text-muted-foreground">
                                    {section.links.map((link, linkIdx) => (
                                        ...
                                        >
                                            <a className="font-mono text-sm" href={link.url}>{link.text.toUpperCase()}</a>
                                        </li>
                                    ))}
                                </ul>
                            </div>
