...
export default function MinimalCardDemo() {
    ...
    return (
        ...
        >
                            ...
                            <ExpandableScreenTrigger key={card.title}>
                                <MinimalCard className="relative">
                                    ...
                                    <div className="w-full absolute top-0 right-0 text-left py-1 px-3">
                                        <MinimalCardTitle className="flex justify-between px-2 py-2 rounded-md backdrop-blur-md bg-transparent bg-white/40">
                                            <span className="font-mono text-sm text-black">{card.title}</span>
                                            <Badge className="rounded-sm py-[1px] border-1 border-zinc-700 bg-black text-white font-mono text-xs">Hello</Badge>
                                        </MinimalCardTitle>
                                        <MinimalCardDescription>
                                        </MinimalCardDescription>
                                    </div>
            ...
            <ExpandableScreenContent className="bg-primary z-50">
