...
const usePrevNextButtons = (emblaApi: EmblaCarouselType | undefined): UsePrevNextButtonsReturn => {
...
const useDotButton = (emblaApi: EmblaCarouselType | undefined): UseDotButtonReturn => {
...
const DotButton: React.FC<ButtonProps> = ({ children, ...restProps }) => {
  return (
...
interface SlideWithLoadingProps {
  image: SlideImage;
}

const SlideWithLoading: React.FC<SlideWithLoadingProps> = ({ image }) => {
...
const ProjectImageCarousel: React.FC<ProjectImageCarouselProps> = ({ slides, options }) => {
